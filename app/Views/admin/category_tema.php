    ...
    <div class="container-xl">
        <div class="page-header d-print-none mb-3">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <div class="diulem-admin-page-note">Kelompokkan tema website agar katalog admin tetap rapi dan pengguna lebih mudah memahami gaya undangan yang tersedia.</div>
                </div>
                <div class="col-auto">
                ...
                <div class="card diulem-admin-summary-card">
                    <div class="card-body">
                        <div>
                            ...
                            <div class="diulem-admin-summary-help">Semua label kategori untuk tema website.</div>
                        </div>
                        <span class="diulem-admin-stat-icon"><i class="ti ti-category"></i></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    <h3 class="card-title">Data Kategori Undangan Online</h3>
                    <div class="diulem-admin-card-note">Slug yang rapi akan membantu saat kategori dipakai kembali di katalog atau filter konten.</div>
                </div>
            </div>
